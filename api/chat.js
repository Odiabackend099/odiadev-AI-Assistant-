...
module.exports = async function handler(req, res){
  ...
  const system = 'You are the ODIADEV Voice AI assistant for Nigerian businesses. Keep replies concise, clear, Naija-friendly. Avoid corporate jargon.';
  ...
  try{
    ...
    if(!r.ok){
      ...
      res.statusCode = 502;
      return res.end(`Anthropic error: ${errText}`);
    }
